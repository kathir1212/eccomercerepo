...
export const AppContextProvider = ({children}) => {
 ...
 const fetchSeller = async () => {
        try {
            const {data} = await axios.get('https://eccomercerepobe.onrender.com/api/seller/is-auth');
            if(data.success){
                setIsSeller(true)
            }else{
                setIsSeller(false)
    ...
    const fetchUser = async () => {
        try{
    const {data} = await axios.get('https://eccomercerepobe.onrender.com/api/user/is-auth');
    if(data.success){
 setUser(data.user)
setCartItems(data.user.cartItems)
    ...
    const fetchProducts = async () =>{
        try{
   const { data } = await axios.get('https://eccomercerepobe.onrender.com/api/product/list')

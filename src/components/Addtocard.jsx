 ...
 const placeOrder = async () => {
  try {
    ...
    if (paymentOption === 'COD') {
      const response = await axios.post('https://eccomercerepobe.onrender.com/api/order/cod', {
        userId: user._id,
      ...
      if (data.success) {
        ...
        alert(data.message,"3" || "Order failed. Try again.");
         ...
         const response = await axios.post('https://eccomercerepobe.onrender.com/api/order/stripe', {
        userId: user._id,
        items: cartArray.map(item => ({
          product: item._id,
          quantity: item.quantity,
